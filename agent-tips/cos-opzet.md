# De Chief of Staff-opzet: lokaal, lussen en een menselijke poort

Het denkmodel staat in [het gedachtegoed](../gedachtegoed.md); dit is de
verdieping: waaróm deze vorm werkt. Drie keuzes dragen alles.

## 1. Lokaal en leesbaar (de machine in de meterkast)

De CoS draait op een eigen machine bij mij thuis, niet in een cloud-dienst.
Dat is geen nostalgie maar architectuur:

- **De data blijft van mij.** Berichten, agenda en dossiers staan in gewone,
  leesbare bestanden en databases die ik zelf kan openen, back-uppen en
  corrigeren.
- **Lezen en versturen zijn gescheiden paden.** Het systeem leest feeds
  read-only; alles wat de deur uit wil moet langs één bewaakte verzendpoort.
  Een binnenkomend bericht kán daardoor nooit zelf een verzending uitlokken,
  hoe listig het ook geformuleerd is.
- **Een grens die in de structuur zit, hoeft niet bewaakt te worden.** Wat
  het systeem niet kán, hoef je niet te verbieden.

## 2. Lussen in plaats van een alwetende agent

Geen enkele agent "runt" mijn leven; een handvol kleine, geplande lussen doet
elk één ding goed:
...
die stilvalt wordt gezien in plaats van gemist.
...
code-wijziging ruimer kan, en elke verruiming is terug te draaien.
